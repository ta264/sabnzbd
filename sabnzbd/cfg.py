...
ncenter_classes = OptionList('ncenter', 'ncenter_classes', DEF_NOTIFY_KEYS)

# [ntfosd]
ntfosd_enable = OptionBool('ntfosd', 'ntfosd_enable', not sabnzbd.WIN32 and not sabnzbd.DARWIN)
ntfosd_classes = OptionList('ntfosd', 'ntfosd_classes', DEF_NOTIFY_KEYS)
...
prowl_prio_complete = OptionNumber('prowl', 'prowl_prio_complete', -3)
prowl_prio_failed = OptionNumber('prowl', 'prowl_prio_failed', -3)
prowl_prio_disk_full = OptionNumber('prowl', 'prowl_prio_disk_full', -3)
